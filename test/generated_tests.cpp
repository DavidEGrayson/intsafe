...
TEST_CASE("CHAR is the same as uint8_t")
{
...
TEST_CASE("ULONGLONG is the same as uint64_t")
{
    REQUIRE(sizeof(ULONGLONG) == 8);
    ULONGLONG x = 0;
    REQUIRE((ULONGLONG)(x - 1) > x);
    REQUIRE_FALSE(std::is_pointer<ULONGLONG>::value);
}
...
TEST_CASE("ULONG_PTR is the same as uint64_t")
{
    REQUIRE(sizeof(ULONG_PTR) == 8);
    ULONG_PTR x = 0;
    REQUIRE((ULONG_PTR)(x - 1) > x);
    REQUIRE_FALSE(std::is_pointer<ULONG_PTR>::value);
}
...
TEST_CASE("UShortToChar")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(UShortToChar(0xff, &out));
        REQUIRE(out == 0xff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == UShortToChar(0x100, &out));
    }
...
TEST_CASE("WordToChar")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(WordToChar(0xff, &out));
        REQUIRE(out == 0xff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == WordToChar(0x100, &out));
    }
...
TEST_CASE("ShortToChar")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ShortToChar(0xff, &out));
        REQUIRE(out == 0xff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ShortToChar(0x100, &out));
    }
...
TEST_CASE("UIntToChar")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(UIntToChar(0xff, &out));
        REQUIRE(out == 0xff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == UIntToChar(0x100, &out));
    }
...
TEST_CASE("ULongToChar")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongToChar(0xff, &out));
        REQUIRE(out == 0xff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongToChar(0x100, &out));
    }
...
TEST_CASE("DWordToChar")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordToChar(0xff, &out));
        REQUIRE(out == 0xff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == DWordToChar(0x100, &out));
    }
...
TEST_CASE("IntToChar")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntToChar(0xff, &out));
        REQUIRE(out == 0xff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == IntToChar(0x100, &out));
    }
...
TEST_CASE("IntToULongLong")
{
    ULONGLONG out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&IntToULongLong), HRESULT (*)(_In_ INT, _Out_ ULONGLONG *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(IntToULongLong(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntToULongLong(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == IntToULongLong(-0x1LL, &out));
    }
...
TEST_CASE("IntToULongPtr")
{
    ULONG_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&IntToULongPtr), HRESULT (*)(_In_ INT, _Out_ ULONG_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(IntToULongPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntToULongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == IntToULongPtr(-0x1LL, &out));
    }
...
TEST_CASE("LongToChar")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongToChar(0xff, &out));
        REQUIRE(out == 0xff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == LongToChar(0x100, &out));
    }
...
TEST_CASE("LongToULongLong")
{
    ULONGLONG out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&LongToULongLong), HRESULT (*)(_In_ LONG, _Out_ ULONGLONG *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(LongToULongLong(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongToULongLong(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == LongToULongLong(-0x1LL, &out));
    }
...
TEST_CASE("LongToULongPtr")
{
    ULONG_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&LongToULongPtr), HRESULT (*)(_In_ LONG, _Out_ ULONG_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(LongToULongPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongToULongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == LongToULongPtr(-0x1LL, &out));
    }
...
TEST_CASE("ULongLongToUInt")
{
    UINT out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToUInt), HRESULT (*)(_In_ ULONGLONG, _Out_ UINT *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToUInt(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToUInt(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToUInt(0x100000000, &out));
    }

}

TEST_CASE("ULongLongToULong")
{
    ULONG out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToULong), HRESULT (*)(_In_ ULONGLONG, _Out_ ULONG *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToULong(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToULong(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToULong(0x100000000, &out));
    }

}

TEST_CASE("ULongLongToDWord")
{
    DWORD out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToDWord), HRESULT (*)(_In_ ULONGLONG, _Out_ DWORD *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToDWord(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToDWord(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToDWord(0x100000000, &out));
    }

}

TEST_CASE("ULongLongToInt")
{
    INT out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToInt), HRESULT (*)(_In_ ULONGLONG, _Out_ INT *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToInt(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToInt(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToInt(0x80000000, &out));
    }

}

TEST_CASE("ULongLongToLong")
{
    LONG out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToLong), HRESULT (*)(_In_ ULONGLONG, _Out_ LONG *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToLong(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToLong(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToLong(0x80000000, &out));
    }

}

TEST_CASE("ULongLongToInt64")
{
    INT64 out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToInt64), HRESULT (*)(_In_ ULONGLONG, _Out_ INT64 *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToInt64(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToInt64(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToInt64(0x8000000000000000, &out));
    }

}

TEST_CASE("ULongLongToUIntPtr")
{
    UINT_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToUIntPtr), HRESULT (*)(_In_ ULONGLONG, _Out_ UINT_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToUIntPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToUIntPtr(0xffffffffffffffff, &out));
        REQUIRE(out == 0xffffffffffffffff);
    }

}

TEST_CASE("ULongLongToSizeT")
{
    size_t out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToSizeT), HRESULT (*)(_In_ ULONGLONG, _Out_ size_t *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToSizeT(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToSizeT(0xffffffffffffffff, &out));
        REQUIRE(out == 0xffffffffffffffff);
    }

}

TEST_CASE("ULongLongToDWordPtr")
{
    DWORD_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToDWordPtr), HRESULT (*)(_In_ ULONGLONG, _Out_ DWORD_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToDWordPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToDWordPtr(0xffffffffffffffff, &out));
        REQUIRE(out == 0xffffffffffffffff);
    }

}

TEST_CASE("ULongLongToULongPtr")
{
    ULONG_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToULongPtr), HRESULT (*)(_In_ ULONGLONG, _Out_ ULONG_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToULongPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToULongPtr(0xffffffffffffffff, &out));
        REQUIRE(out == 0xffffffffffffffff);
    }

}

TEST_CASE("ULongLongToIntPtr")
{
    INT_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToIntPtr), HRESULT (*)(_In_ ULONGLONG, _Out_ INT_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToIntPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToIntPtr(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToIntPtr(0x8000000000000000, &out));
    }

}

TEST_CASE("ULongLongToLongPtr")
{
    LONG_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToLongPtr), HRESULT (*)(_In_ ULONGLONG, _Out_ LONG_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToLongPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToLongPtr(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToLongPtr(0x8000000000000000, &out));
    }

}

TEST_CASE("ULongLongToPtrdiffT")
{
    ptrdiff_t out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToPtrdiffT), HRESULT (*)(_In_ ULONGLONG, _Out_ ptrdiff_t *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToPtrdiffT(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToPtrdiffT(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToPtrdiffT(0x8000000000000000, &out));
    }

}

TEST_CASE("ULongLongToSSIZET")
{
    SSIZE_T out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongLongToSSIZET), HRESULT (*)(_In_ ULONGLONG, _Out_ SSIZE_T *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongLongToSSIZET(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToSSIZET(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToSSIZET(0x8000000000000000, &out));
    }
...
TEST_CASE("Int64ToULongLong")
{
    ULONGLONG out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&Int64ToULongLong), HRESULT (*)(_In_ INT64, _Out_ ULONGLONG *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(Int64ToULongLong(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(Int64ToULongLong(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToULongLong(-0x1LL, &out));
    }
...
TEST_CASE("Int64ToULongPtr")
{
    ULONG_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&Int64ToULongPtr), HRESULT (*)(_In_ INT64, _Out_ ULONG_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(Int64ToULongPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(Int64ToULongPtr(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToULongPtr(-0x1LL, &out));
    }
...
TEST_CASE("ULongPtrToUInt")
{
    UINT out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToUInt), HRESULT (*)(_In_ ULONG_PTR, _Out_ UINT *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToUInt(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToUInt(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToUInt(0x100000000, &out));
    }

}

TEST_CASE("ULongPtrToULong")
{
    ULONG out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToULong), HRESULT (*)(_In_ ULONG_PTR, _Out_ ULONG *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToULong(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToULong(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToULong(0x100000000, &out));
    }

}

TEST_CASE("ULongPtrToDWord")
{
    DWORD out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToDWord), HRESULT (*)(_In_ ULONG_PTR, _Out_ DWORD *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToDWord(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToDWord(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToDWord(0x100000000, &out));
    }

}

TEST_CASE("ULongPtrToInt")
{
    INT out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToInt), HRESULT (*)(_In_ ULONG_PTR, _Out_ INT *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToInt(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToInt(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToInt(0x80000000, &out));
    }

}

TEST_CASE("ULongPtrToLong")
{
    LONG out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToLong), HRESULT (*)(_In_ ULONG_PTR, _Out_ LONG *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToLong(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToLong(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToLong(0x80000000, &out));
    }

}

TEST_CASE("ULongPtrToInt64")
{
    INT64 out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToInt64), HRESULT (*)(_In_ ULONG_PTR, _Out_ INT64 *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToInt64(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToInt64(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToInt64(0x8000000000000000, &out));
    }

}

TEST_CASE("ULongPtrToUIntPtr")
{
    UINT_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToUIntPtr), HRESULT (*)(_In_ ULONG_PTR, _Out_ UINT_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToUIntPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToUIntPtr(0xffffffffffffffff, &out));
        REQUIRE(out == 0xffffffffffffffff);
    }

}

TEST_CASE("ULongPtrToIntPtr")
{
    INT_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToIntPtr), HRESULT (*)(_In_ ULONG_PTR, _Out_ INT_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToIntPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToIntPtr(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToIntPtr(0x8000000000000000, &out));
    }

}

TEST_CASE("ULongPtrToLongPtr")
{
    LONG_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToLongPtr), HRESULT (*)(_In_ ULONG_PTR, _Out_ LONG_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToLongPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToLongPtr(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToLongPtr(0x8000000000000000, &out));
    }

}

TEST_CASE("ULongPtrToPtrdiffT")
{
    ptrdiff_t out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToPtrdiffT), HRESULT (*)(_In_ ULONG_PTR, _Out_ ptrdiff_t *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToPtrdiffT(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToPtrdiffT(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToPtrdiffT(0x8000000000000000, &out));
    }

}

TEST_CASE("ULongPtrToSSIZET")
{
    SSIZE_T out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&ULongPtrToSSIZET), HRESULT (*)(_In_ ULONG_PTR, _Out_ SSIZE_T *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(ULongPtrToSSIZET(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToSSIZET(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToSSIZET(0x8000000000000000, &out));
    }
...
TEST_CASE("IntPtrToULongLong")
{
    ULONGLONG out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&IntPtrToULongLong), HRESULT (*)(_In_ INT_PTR, _Out_ ULONGLONG *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(IntPtrToULongLong(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntPtrToULongLong(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == IntPtrToULongLong(-0x1LL, &out));
    }
...
TEST_CASE("IntPtrToULongPtr")
{
    ULONG_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&IntPtrToULongPtr), HRESULT (*)(_In_ INT_PTR, _Out_ ULONG_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(IntPtrToULongPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntPtrToULongPtr(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == IntPtrToULongPtr(-0x1LL, &out));
    }
...
TEST_CASE("LongPtrToULongLong")
{
    ULONGLONG out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&LongPtrToULongLong), HRESULT (*)(_In_ LONG_PTR, _Out_ ULONGLONG *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(LongPtrToULongLong(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToULongLong(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == LongPtrToULongLong(-0x1LL, &out));
    }
...
TEST_CASE("LongPtrToULongPtr")
{
    ULONG_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&LongPtrToULongPtr), HRESULT (*)(_In_ LONG_PTR, _Out_ ULONG_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(LongPtrToULongPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToULongPtr(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == LongPtrToULongPtr(-0x1LL, &out));
    }
...
TEST_CASE("PtrdiffTToULongPtr")
{
    ULONG_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&PtrdiffTToULongPtr), HRESULT (*)(_In_ ptrdiff_t, _Out_ ULONG_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(PtrdiffTToULongPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(PtrdiffTToULongPtr(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == PtrdiffTToULongPtr(-0x1LL, &out));
    }
...
TEST_CASE("SSIZETToULongPtr")
{
    ULONG_PTR out = INITIAL_VALUE;

    SECTION("has the right type")
    {
        REQUIRE((std::is_same<decltype(&SSIZETToULongPtr), HRESULT (*)(_In_ SSIZE_T, _Out_ ULONG_PTR *)>::value));
    }

    SECTION("converts 0 to 0")
    {
        REQUIRE_FALSE(SSIZETToULongPtr(0, &out));
        REQUIRE(out == 0);
    }

    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SSIZETToULongPtr(0x7fffffffffffffff, &out));
        REQUIRE(out == 0x7fffffffffffffff);
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == SSIZETToULongPtr(-0x1LL, &out));
    }
...
TEST_CASE("UINT_PTR is the same as uint32_t")
{
    REQUIRE(sizeof(UINT_PTR) == 4);
    UINT_PTR x = 0;
    REQUIRE((UINT_PTR)(x - 1) > x);
    REQUIRE_FALSE(std::is_pointer<UINT_PTR>::value);
}

TEST_CASE("size_t is the same as uint32_t")
{
...
TEST_CASE("DWORD_PTR is the same as uint32_t")
{
    REQUIRE(sizeof(DWORD_PTR) == 4);
    DWORD_PTR x = 0;
    REQUIRE((DWORD_PTR)(x - 1) > x);
    REQUIRE_FALSE(std::is_pointer<DWORD_PTR>::value);
}

TEST_CASE("ULONG_PTR is the same as uint32_t")
{
    REQUIRE(sizeof(ULONG_PTR) == 4);
    ULONG_PTR x = 0;
    REQUIRE((ULONG_PTR)(x - 1) > x);
    REQUIRE_FALSE(std::is_pointer<ULONG_PTR>::value);
}

TEST_CASE("INT_PTR is the same as int32_t")
{
    REQUIRE(sizeof(INT_PTR) == 4);
    INT_PTR x = 0;
    REQUIRE((INT_PTR)(x - 1) < x);
    REQUIRE_FALSE(std::is_pointer<INT_PTR>::value);
}

TEST_CASE("LONG_PTR is the same as int32_t")
{
    REQUIRE(sizeof(LONG_PTR) == 4);
    LONG_PTR x = 0;
    REQUIRE((LONG_PTR)(x - 1) < x);
    REQUIRE_FALSE(std::is_pointer<LONG_PTR>::value);
}

TEST_CASE("ptrdiff_t is the same as int32_t")
{
    REQUIRE(sizeof(ptrdiff_t) == 4);
    ptrdiff_t x = 0;
    REQUIRE((ptrdiff_t)(x - 1) < x);
    REQUIRE_FALSE(std::is_pointer<ptrdiff_t>::value);
}

TEST_CASE("SSIZE_T is the same as int32_t")
{
    REQUIRE(sizeof(SSIZE_T) == 4);
    SSIZE_T x = 0;
    REQUIRE((SSIZE_T)(x - 1) < x);
    REQUIRE_FALSE(std::is_pointer<SSIZE_T>::value);
}
...
TEST_CASE("UIntToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(UIntToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == UIntToIntPtr(0x80000000, &out));
    }
...
TEST_CASE("UIntToLongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(UIntToLongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == UIntToLongPtr(0x80000000, &out));
    }
...
TEST_CASE("UIntToPtrdiffT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(UIntToPtrdiffT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == UIntToPtrdiffT(0x80000000, &out));
    }
...
TEST_CASE("UIntToSSIZET")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(UIntToSSIZET(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == UIntToSSIZET(0x80000000, &out));
    }
...
TEST_CASE("ULongToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongToIntPtr(0x80000000, &out));
    }
...
TEST_CASE("ULongToLongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongToLongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongToLongPtr(0x80000000, &out));
    }
...
TEST_CASE("ULongToPtrdiffT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongToPtrdiffT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongToPtrdiffT(0x80000000, &out));
    }
...
TEST_CASE("ULongToSSIZET")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongToSSIZET(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongToSSIZET(0x80000000, &out));
    }
...
TEST_CASE("DWordToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == DWordToIntPtr(0x80000000, &out));
    }
...
TEST_CASE("DWordToLongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordToLongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == DWordToLongPtr(0x80000000, &out));
    }
...
TEST_CASE("DWordToPtrdiffT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordToPtrdiffT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == DWordToPtrdiffT(0x80000000, &out));
    }
...
TEST_CASE("DWordToSSIZET")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordToSSIZET(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == DWordToSSIZET(0x80000000, &out));
    }
...
TEST_CASE("ULongLongToUIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToUIntPtr(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToUIntPtr(0x100000000, &out));
    }
...
TEST_CASE("ULongLongToSizeT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToSizeT(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToSizeT(0x100000000, &out));
    }
...
TEST_CASE("ULongLongToDWordPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToDWordPtr(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToDWordPtr(0x100000000, &out));
    }
...
TEST_CASE("ULongLongToULongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToULongPtr(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToULongPtr(0x100000000, &out));
    }
...
TEST_CASE("ULongLongToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToIntPtr(0x80000000, &out));
    }
...
TEST_CASE("ULongLongToLongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToLongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToLongPtr(0x80000000, &out));
    }
...
TEST_CASE("ULongLongToPtrdiffT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToPtrdiffT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToPtrdiffT(0x80000000, &out));
    }
...
TEST_CASE("ULongLongToSSIZET")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongLongToSSIZET(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongLongToSSIZET(0x80000000, &out));
    }
...
TEST_CASE("Int64ToUIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(Int64ToUIntPtr(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToUIntPtr(0x100000000, &out));
    }
...
TEST_CASE("Int64ToSizeT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(Int64ToSizeT(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToSizeT(0x100000000, &out));
    }
...
TEST_CASE("Int64ToDWordPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(Int64ToDWordPtr(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToDWordPtr(0x100000000, &out));
    }
...
TEST_CASE("Int64ToULongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(Int64ToULongPtr(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToULongPtr(0x100000000, &out));
    }
...
TEST_CASE("Int64ToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(Int64ToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("converts the minimum value")
    {
        REQUIRE_FALSE(Int64ToIntPtr(-0x80000000LL, &out));
        REQUIRE(out == -0x80000000LL);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToIntPtr(0x80000000, &out));
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToIntPtr(-0x80000001LL, &out));
    }
...
TEST_CASE("Int64ToLongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(Int64ToLongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("converts the minimum value")
    {
        REQUIRE_FALSE(Int64ToLongPtr(-0x80000000LL, &out));
        REQUIRE(out == -0x80000000LL);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToLongPtr(0x80000000, &out));
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToLongPtr(-0x80000001LL, &out));
    }
...
TEST_CASE("Int64ToPtrdiffT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(Int64ToPtrdiffT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("converts the minimum value")
    {
        REQUIRE_FALSE(Int64ToPtrdiffT(-0x80000000LL, &out));
        REQUIRE(out == -0x80000000LL);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToPtrdiffT(0x80000000, &out));
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToPtrdiffT(-0x80000001LL, &out));
    }
...
TEST_CASE("Int64ToSSIZET")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(Int64ToSSIZET(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("converts the minimum value")
    {
        REQUIRE_FALSE(Int64ToSSIZET(-0x80000000LL, &out));
        REQUIRE(out == -0x80000000LL);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToSSIZET(0x80000000, &out));
    }

    SECTION("rejects minimum value - 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == Int64ToSSIZET(-0x80000001LL, &out));
    }
...
TEST_CASE("UIntPtrToInt64")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(UIntPtrToInt64(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }
...
TEST_CASE("UIntPtrToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(UIntPtrToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == UIntPtrToIntPtr(0x80000000, &out));
    }
...
TEST_CASE("UIntPtrToLongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(UIntPtrToLongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == UIntPtrToLongPtr(0x80000000, &out));
    }
...
TEST_CASE("UIntPtrToSSIZET")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(UIntPtrToSSIZET(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == UIntPtrToSSIZET(0x80000000, &out));
    }
...
TEST_CASE("SizeTToInt64")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SizeTToInt64(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }
...
TEST_CASE("SizeTToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SizeTToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == SizeTToIntPtr(0x80000000, &out));
    }
...
TEST_CASE("SizeTToLongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SizeTToLongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == SizeTToLongPtr(0x80000000, &out));
    }
...
TEST_CASE("SizeTToPtrdiffT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SizeTToPtrdiffT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == SizeTToPtrdiffT(0x80000000, &out));
    }
...
TEST_CASE("SizeTToSSIZET")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SizeTToSSIZET(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == SizeTToSSIZET(0x80000000, &out));
    }
...
TEST_CASE("DWordPtrToInt64")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordPtrToInt64(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }
...
TEST_CASE("DWordPtrToUIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordPtrToUIntPtr(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }
...
TEST_CASE("DWordPtrToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordPtrToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == DWordPtrToIntPtr(0x80000000, &out));
    }
...
TEST_CASE("DWordPtrToLongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordPtrToLongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == DWordPtrToLongPtr(0x80000000, &out));
    }
...
TEST_CASE("DWordPtrToPtrdiffT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordPtrToPtrdiffT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == DWordPtrToPtrdiffT(0x80000000, &out));
    }
...
TEST_CASE("DWordPtrToSSIZET")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(DWordPtrToSSIZET(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == DWordPtrToSSIZET(0x80000000, &out));
    }
...
TEST_CASE("ULongPtrToInt64")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToInt64(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }
...
TEST_CASE("ULongPtrToUIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToUIntPtr(0xffffffff, &out));
        REQUIRE(out == 0xffffffff);
    }
...
TEST_CASE("ULongPtrToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToIntPtr(0x80000000, &out));
    }
...
TEST_CASE("ULongPtrToLongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToLongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToLongPtr(0x80000000, &out));
    }
...
TEST_CASE("ULongPtrToPtrdiffT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToPtrdiffT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToPtrdiffT(0x80000000, &out));
    }
...
TEST_CASE("ULongPtrToSSIZET")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(ULongPtrToSSIZET(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("rejects maximum value + 1")
    {
        REQUIRE(INTSAFE_E_ARITHMETIC_OVERFLOW  == ULongPtrToSSIZET(0x80000000, &out));
    }
...
TEST_CASE("IntPtrToUInt")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntPtrToUInt(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("IntPtrToULong")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntPtrToULong(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("IntPtrToDWord")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntPtrToDWord(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("IntPtrToULongLong")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntPtrToULongLong(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("IntPtrToUIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntPtrToUIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("IntPtrToSizeT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntPtrToSizeT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("IntPtrToDWordPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntPtrToDWordPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("IntPtrToULongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(IntPtrToULongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("LongPtrToUInt")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToUInt(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("LongPtrToULong")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToULong(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("LongPtrToDWord")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToDWord(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("LongPtrToULongLong")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToULongLong(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("LongPtrToUIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToUIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("LongPtrToSizeT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToSizeT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("LongPtrToDWordPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToDWordPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("LongPtrToULongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToULongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("LongPtrToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(LongPtrToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("converts the minimum value")
    {
        REQUIRE_FALSE(LongPtrToIntPtr(-0x80000000LL, &out));
        REQUIRE(out == -0x80000000LL);
    }
...
TEST_CASE("PtrdiffTToUInt")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(PtrdiffTToUInt(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("PtrdiffTToULong")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(PtrdiffTToULong(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("PtrdiffTToDWord")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(PtrdiffTToDWord(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("PtrdiffTToUIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(PtrdiffTToUIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("PtrdiffTToSizeT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(PtrdiffTToSizeT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("PtrdiffTToDWordPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(PtrdiffTToDWordPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("PtrdiffTToULongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(PtrdiffTToULongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("SSIZETToUInt")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SSIZETToUInt(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("SSIZETToULong")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SSIZETToULong(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("SSIZETToDWord")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SSIZETToDWord(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("SSIZETToUIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SSIZETToUIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("SSIZETToSizeT")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SSIZETToSizeT(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("SSIZETToDWordPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SSIZETToDWordPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("SSIZETToULongPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SSIZETToULongPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }
...
TEST_CASE("SSIZETToIntPtr")
{
    ...
    SECTION("converts the maximum value")
    {
        REQUIRE_FALSE(SSIZETToIntPtr(0x7fffffff, &out));
        REQUIRE(out == 0x7fffffff);
    }

    SECTION("converts the minimum value")
    {
        REQUIRE_FALSE(SSIZETToIntPtr(-0x80000000LL, &out));
        REQUIRE(out == -0x80000000LL);
    }
