...
__MINGW_INTSAFE_API __MINGW_INTSAFE_CONV(LongLongToUIntPtr, LONGLONG, UINT_PTR)
...
__MINGW_INTSAFE_API __MINGW_INTSAFE_CONV(LongLongToULongPtr, LONGLONG, ULONG_PTR)
